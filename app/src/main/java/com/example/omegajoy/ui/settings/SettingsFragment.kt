package com.example.omegajoy.ui.settings
 ...
 */
class SettingsFragment : FullFrameFragment() {
    override fun onCreateView(
        ...
        button_to_code.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_nav_settings_to_nav_code)
        )
        val button_to_home: ImageButton = root.findViewById(R.id.button_to_home)
        button_to_home.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_nav_settings_to_nav_home)
        )
