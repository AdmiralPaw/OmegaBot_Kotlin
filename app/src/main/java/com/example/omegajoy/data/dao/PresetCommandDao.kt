...
interface PresetCommandDao {
    ...
    @Query("SELECT PresetCommand.id, PresetCommand.presetId, PresetCommand.commandId, PresetCommand.position FROM PresetCommand JOIN Preset ON presetId = Preset.id WHERE Preset.attachedButton = :name")
